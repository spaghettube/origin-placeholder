...
execute if score @s atkspd matches 1990.. unless score @s ratio matches 1345517 run with dmg attribute @s minecraft:generic.attack_damage with simpledmg calculate "((0@(dmg))^2)^(1/2)" with dmgdisplay calculate "(1.8^((0-0.05)*@(simpledmg)-0.029))*(0.976*@(simpledmg)+1.481)" title @s actionbar [{"text":"Damage: "},{"text":"@(dmgdisplay)"}]
